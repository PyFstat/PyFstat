...
outdir : pytest.fixture (scope="class")
...
data_fixture : pytest.fixture (scope="class")
...
BaseForTestsWithOutdir : unittest.TestCase (deprecated)
    Legacy base class for tests requiring an output directory.
    Use the `outdir` fixture instead.

BaseForTestsWithData : unittest.TestCase (deprecated)
